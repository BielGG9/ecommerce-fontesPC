...
export const routes: Routes = [
  ...
  { path: 'admin/marca', component: MarcaComponent, canActivate: [canActivateAuthRole] },
  { path: 'admin/fontes', component: FonteComponent, canActivate: [canActivateAuthRole] },
  { path: 'admin/modelos', component: ModeloComponent, canActivate: [canActivateAuthRole] },
  { path: 'home', component: HomeComponent },
  { path: 'admin/funcionarios', component: FuncionarioComponent, canActivate: [canActivateAuthRole] },

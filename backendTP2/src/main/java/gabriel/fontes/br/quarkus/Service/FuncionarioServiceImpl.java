...
public class FuncionarioServiceImpl implements FuncionarioService {
    ...
    public FuncionarioResponse create(FuncionarioRequest dto) {
        ...
        novoFuncionario.setDataAdmissao(dto.dataAdmissao());

        // Buscar o departamento pelo ID fornecido
        Departamento departamento = departamentoRepository.findByIdOptional(dto.idDepartamento())
                .orElseThrow(() -> new NotFoundException("Departamento com ID " + dto.idDepartamento() + " não encontrado."));
    ...
    @Override
    public List<FuncionarioResponse> findAll(int page, int pageSize, String nome) {
